package com.example.shepin.request;
...
import com.example.shepin.common.UploadFile;
import com.example.shepin.response.CommonResponse;
import com.example.shepin.utils.ClassUtil;
...
public abstract class CommonRequest<T extends  CommonResponse> {
    ...
    protected CommonRequest(String method, String version) {
        this.method = method;
        this.version = version;
    }
