package com.example.shepin.sign;


import com.example.shepin.utils.Base64Util;
...
public class SopSignature {
    ...
    public static PrivateKey getPrivateKeyFromPKCS8(String algorithm,
        ...
        try {
            ...
            // 取得私钥  for PKCS#1
            RSAPrivateKeyStructure asn1PrivKey = new RSAPrivateKeyStructure((ASN1Sequence) ASN1Sequence.fromByteArray(encodedKey));
